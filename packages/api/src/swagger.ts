export const swaggerDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Domain-oriented API for the Asset Management Platform POC. Two domains: billing (invoices, transactions) owned by the Billing team, and accounts (onboarding) owned by the Open Account team.",
  },
  servers: [{ url: "http://localhost:3000", description: "Development" }],
  tags: [
    { name: "Billing", description: "Owned by Billing team" },
    { name: "Accounts", description: "Owned by Open Account team" },
  ],
  paths: {
